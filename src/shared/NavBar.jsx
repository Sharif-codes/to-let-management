...
const NavBar = () => {
    ...
    const NavItem = <>
        ...
        <Link to='/bookings'><li><a>MyBooking</a></li></Link>
    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <Link to='/' className="flex items-center gap-3"><img className="w-16" src="/src/assets/logo.svg" alt="" /> <span className="text-3xl font-bold text-red-500">Car Doctor</span></Link>
            </div>
